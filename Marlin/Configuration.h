...
#define STRING_CONFIG_H_AUTHOR "(Puki, pupsbot config)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Pupsbot"
 ...
 */
#define MAX_BED_POWER 185 // limits duty cycle to bed; 255=full current

#if ENABLED(PIDTEMPBED)

  //#define PID_BED_DEBUG // Sends debug data to the serial port.

  // Puksbot w.o. magnetic bed
  #define DEFAULT_bedKp 273.97
  #define DEFAULT_bedKi 35.58
  #define DEFAULT_bedKd 527.42
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 289.46}
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER  0.3   // Z offset: -below +above  [the nozzle] -> lower number lowers extruder head
